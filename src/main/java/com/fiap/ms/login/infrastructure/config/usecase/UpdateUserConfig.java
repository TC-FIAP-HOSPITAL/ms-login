...
import com.fiap.ms.login.application.usecase.user.implementation.UpdateUserUsecaseImpl;
...
public class UpdateUserConfig {
    ...
    @Bean
    public UpdateUserUsecaseImpl updateUserUsecase(User user,
                                                   PasswordEncoder passwordEncoder,
                                                   SecurityUtil securityUtil) {
        return new UpdateUserUsecaseImpl(user, passwordEncoder, securityUtil);
    }
}
